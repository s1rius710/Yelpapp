...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        return YelpClient.sharedInstance.searchWithTerm(term, completion: completion)
    }
